...
export default function FAQ() {
  return (
    <div className="max-w-4xl mx-auto w-full pt-8 pb-24 text-slate-700 dark:text-gray-300">
      
      <div className="mb-16">
        <h1 className="text-4xl font-bold mb-4 font-serif text-slate-900 dark:text-white">Frequently Asked Questions</h1>
      ...
      <div className="border-t border-[#d8e2d7] dark:border-gray-800 pt-12 mt-8">
        <h2 className="text-2xl font-bold mb-6 font-serif text-slate-900 dark:text-white">Still Have Questions?</h2>
