...
export default function Guide() {
  return (
    <div className="max-w-4xl mx-auto w-full min-w-0 pt-8 pb-24 text-gray-700 dark:text-gray-300">
      <div className="mb-12">
      ...
      <section className="mb-16">
        ...
        <div className="space-y-4 text-gray-600 dark:text-gray-400 leading-relaxed">
          ...
          <p>Big O focuses on the <em className="text-gray-800 dark:text-gray-300">rate of growth</em>, so constants and smaller terms are usually ignored for large inputs.</p>
        </div>
      </section>
      ...
      <section className="mb-16">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            ...
            <div key={g.label} className="bg-white dark:bg-[#151515] p-4 rounded-lg border border-gray-200 dark:border-gray-800 text-center">
              <p className="text-xs font-bold text-gray-500 dark:text-gray-500 uppercase">{g.label}</p>
              <p className="text-lg font-bold text-gray-900 dark:text-white">{g.val}</p>
            </div>
          ))}
        </div>
      </section>
        ...
        <div className="space-y-12">
          {timeComplexities.map((item) => (
            <div key={item.id} className="min-w-0">
              ...
              <div className="min-w-0 overflow-hidden bg-gray-50 dark:bg-[#171717] rounded-lg my-5 border border-gray-200 dark:border-gray-800">
                <pre className="m-0 max-w-full overflow-x-auto p-5 font-mono text-sm leading-relaxed text-gray-800 dark:text-gray-300 whitespace-pre custom-scrollbar">
                  <code>{item.code}</code>
                </pre>
              </div>
      ...
      <section className="mb-16">
        ...
        <div className="space-y-4 text-gray-600 dark:text-gray-400 leading-relaxed mb-8">
          <p>While time complexity measures how long an algorithm takes to run, <strong className="text-gray-900 dark:text-gray-200">space complexity</strong> measures how much memory it uses.</p>
          <p>When analyzing space complexity, distinguish auxiliary memory from memory already used by the input.</p>
          <ul className="list-disc pl-6 space-y-2">
            <li><strong className="text-gray-900 dark:text-gray-200">Auxiliary space:</strong> Extra space used by the algorithm.</li>
            <li><strong className="text-gray-900 dark:text-gray-200">Input space:</strong> Space required to store the input.</li>
            <li><strong className="text-gray-900 dark:text-gray-200">Total space:</strong> Auxiliary space plus input space.</li>
          </ul>
        </div>
        ...
        <div className="space-y-6">
          {spaceComplexities.map((item) => (
            <div
              key={item.id}
              className="min-w-0 overflow-hidden rounded-lg border border-gray-200 dark:border-gray-800 bg-white dark:bg-[#151515]"
            >
              ...
              <div className="border-t border-gray-200 dark:border-gray-800">
                <pre className="m-0 max-w-full overflow-x-auto p-6 text-sm leading-relaxed text-gray-800 dark:text-gray-300 custom-scrollbar">
                  <code>{item.code}</code>
                </pre>
              </div>
            </div>
      ...
      <section className="mb-16">
        ...
        <div className="space-y-4 text-gray-600 dark:text-gray-400 leading-relaxed mb-6">
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li><strong className="text-gray-900 dark:text-gray-200">Best case:</strong> The input that makes the algorithm perform optimally.</li>
            <li><strong className="text-gray-900 dark:text-gray-200">Average case:</strong> Expected performance for typical inputs.</li>
            <li><strong className="text-gray-900 dark:text-gray-200">Worst case:</strong> The input that makes the algorithm perform most poorly.</li>
          </ul>
          <p>When people discuss Big O, they usually mean worst-case behavior because it gives a useful upper bound.</p>
        </div>

        <div className="border border-gray-200 dark:border-gray-800 rounded-lg p-6 bg-gray-50 dark:bg-[#121212]">
          ...
          <ul className="space-y-3 text-sm text-gray-600 dark:text-gray-400">
            ...
            <li><strong className="text-gray-900 dark:text-gray-200">Worst case:</strong> O(n^2) - already sorted array with poor pivot selection</li>
          </ul>
        </div>
      </section>
      ...
      <section className="mb-16">
        ...
        <ol className="list-decimal pl-6 space-y-4 text-gray-600 dark:text-gray-400 leading-relaxed">
          ...
          <li><strong className="text-gray-900 dark:text-gray-200">Drop non-dominant terms:</strong> O(n^2 + n) becomes O(n^2), O(n + log n) becomes O(n)</li>
          <li><strong className="text-gray-900 dark:text-gray-200">Different inputs use different variables:</strong> If two inputs have different sizes, use variables like O(a + b) or O(a * b)</li>
          <li><strong className="text-gray-900 dark:text-gray-200">Sequential steps add:</strong> If you do A then B, it is O(A + B)</li>
          <li><strong className="text-gray-900 dark:text-gray-200">Nested steps multiply:</strong> If you do B for each A, it is O(A * B)</li>
        </ol>
      </section>
