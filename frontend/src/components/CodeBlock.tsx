...
const CodeBlock: React.FC<CodeBlockProps> = ({ code, language = 'c++' }) => {
  return (
    <div className="min-w-0 rounded-lg overflow-hidden border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-[#161616] shadow-lg dark:shadow-xl my-6 transition-colors duration-300">
      ...
      <div className="min-w-0 overflow-x-auto p-5 custom-scrollbar">
        <pre className="m-0 text-sm font-mono text-gray-800 dark:text-gray-300 leading-relaxed">
          <code>{code}</code>
        </pre>
      </div>
    </div>
